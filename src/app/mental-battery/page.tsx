...
export default function MentalBatteryIntroPage() {
  const estimatedMinutes = Math.ceil(TOTAL_QUESTIONS * 0.3); // ~10–12 menit
    ...
    <div className="min-h-screen font-sans" style={{ background: "#FFFDF8", color: "#1E293B" }}>
      ...
      <header className="py-6 px-4 max-w-5xl mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center gap-2">
          <Image src="/assets/LMHY.png" alt="Let Me Hear You" width={40} height={40} />
      ...
      <main className="px-4 pb-20">
        ...
        <div className="max-w-3xl mx-auto text-center mt-10 md:mt-16 mb-16">
          ...
          <Link
            ...
            className="inline-block bg-indigo-600 text-white px-8 py-4 rounded-full text-lg font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-1 transition-transform"
          >
        ...
        <div className="max-w-4xl mx-auto mt-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {ARCHETYPE_LIST.map((a) => (
              <div
                key={a.id}
                className="bg-white p-6 rounded-2xl border border-slate-100 shadow-[0_2px_10px_rgb(0,0,0,0.03)] text-center hover:shadow-lg transition-shadow"
              >
        ...
        <div className="max-w-3xl mx-auto mt-24">
          <div className="bg-indigo-900 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden shadow-2xl shadow-indigo-900/20">
            {/* Decorative blob */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-600 rounded-full blur-3xl opacity-30 -mr-20 -mt-20"></div>
        ...
        <div className="max-w-2xl mx-auto mt-16 p-5 bg-amber-50 border border-amber-100 rounded-2xl text-center text-sm text-amber-800 shadow-sm">
          <strong className="block mb-1 text-amber-900">⚠️ Penafian Penting</strong> 
